...
from src import TrainingDataCollector , GenerateEmbedding , FaceDetect
...
class RegistrationModule:
    def __init__(self, logFileName):
        ...
        trainImg = tk.Button(self.window, text="Train Images", command=self.getFaceEmbedding, fg="white", bg="#363e75", width=15,
                             height=2,
                             activebackground="#118ce1", font=('times', 15, ' bold '))
    ...
    def collectUserImageForRegistration(self):
        ...
        ap.add_argument("--output", default=f"./datasets/train/{name}",
    ...
    def getFaceEmbedding(self):
        ...
        ap.add_argument("--embeddings", default="./faceEmbeddingModels/embeddings.pt")
        # Argument of insightface
        ap.add_argument('--image-size', default='112', help='')
        args = ap.parse_args()

        genFaceEmbdng = GenerateEmbedding(args)
